...
public class HandlerAdapter {
    ...
    //paramMapping 保存了参数的类名和参数在方法列表中的位置index
  ...
  public ModelAndView handle(
      HttpServletRequest req, HttpServletResponse resp, HandlerMapping handler) throws InvocationTargetException, IllegalAccessException {
